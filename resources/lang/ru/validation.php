...
return [
    ...
    */
    ...
    'custom' => [
        'inn' => [
            'unique' => 'Такой ИНН уже зарегистрирован, обратитесь к администратору сайта чтобы решить разногласия.',
        ],
        'name' => [
            'required' => 'Укажите как к Вам обращаться.',
            'min' => 'Слишком короткое имя.',
            'regex' => 'Укажите человеческое имя:)'
        ],
        'question' => [
            'required' => 'Нужен вопрос.',
            'min' => 'Немного больше слов пожалуйста.'
        ],
        'email' => [
