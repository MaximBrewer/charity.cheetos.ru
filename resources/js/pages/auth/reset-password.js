  ...
  return (
    <div className="flex justify-center items-center w-full py-4 flex-col min-h-screen bg-gray-200">
      ...
      <form
        ...
        <div className="mb-4">
          <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="password"> Пароль </label>
          <input
            type="password"
            id="password"
            name="password"
        ...
        <div className="mb-4">
          <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="password-confirmation"> Повторите пароль </label>
          <input
            type="password"
